...
public class StartupHelper {
     ...
     * 	if (fr.mwet.snake.lwjgl3.StartupHelper.startNewJvmIfRequired(true)) return; // This handles macOS support and helps on Windows.
...
// By extracting to the relevant "ProgramData" folder, which is usually "C:\ProgramData", we avoid this.
     ...
     * <pre>
     * public static void main(String... args) {
     * 	if (fr.mwet.snake.lwjgl3.StartupHelper.startNewJvmIfRequired()) return; // This handles macOS support and helps on Windows.
